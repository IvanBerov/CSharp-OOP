    ...
    public class ExtendedDatabaseTests
    {
        ...
        public void Add_ThrowException_WhenCapacityIsExceeded()
        {
            ...
            Assert.Throws<InvalidOperationException>
                (() => this.extendedDatabase.Add(new Person(16, "Invalid username")));
        }
        ...
        [Test]
        public void Add_ThrowException_WhenTdIsUsed()
        {
            long id = 1;
        ...
        {
            this.extendedDatabase.Add(new Person(1,"Poly"));
            this.extendedDatabase.Add(new Person(2,"Gabriel"));
        ...
        [Test]
        public void Ctor_AddInitialPeople_ToDatabase()
        {
